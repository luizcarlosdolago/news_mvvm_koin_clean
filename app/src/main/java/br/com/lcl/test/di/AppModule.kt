...
val mViewModels = module {
    viewModel {
        LoginViewModel(loginUseCase = get(named(LOGIN_USE_CASE)), prefs = get(named(SHARED_PREFERENCES)))
    }
    viewModel {
...
private const val LOGIN_USE_CASE = "loginUseCase"
private const val GET_NEWS_USE_CASE = "getNewsUseCase"
private const val GET_NEWS_DETAIL_USE_CASE = "getNewsDetailUseCase"
